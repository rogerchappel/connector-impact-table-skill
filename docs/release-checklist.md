...
Use this checklist before cutting a public release for connector-impact-table-skill.
...
- Exercise the CLI smoke path for `connector-impact-table-skill` with the checked-in fixture.
